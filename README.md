...
This project aims to customize the **New Learning** theme for IMC’s Moodle platform, providing branding alignment and improved user experience.
...
2. Reinstall it through the same **Install Plugins** page.
3. Moodle will detect it as an update.
4. Purge caches after update.
