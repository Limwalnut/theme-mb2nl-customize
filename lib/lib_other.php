 ...
 *
 */
function theme_mb2nl_wordlimit($string, $limit = 999, $end = '...', $stripimg = false) {
    ...
    if ($stripimg) {
        // Remove image. It's require for the 'Categories' shortcode.
        $string = preg_replace('/<img[^>]+\>/i', '', $string);
        // Remove the empty paragraph around the image.
...
function theme_mb2nl_adminblock_toggle($cls = 'pb-3') {
    ...
    $cls .= $PAGE->user_is_editing() ? ' d-none' : '';
