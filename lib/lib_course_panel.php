        ...
        if ($show && $iscourse && $k === $name) {
            ...
            if (is_array($box['links'])) {
                ...
                foreach ($box['links'] as $link) {
                    ...
                    $icon = isset($link['icon']) ? '<span class="activitiesimage ' . $link['purpose'] .
                    theme_mb2nl_bsfcls(2, '', 'center', 'center') . '"><img class="activityicon" src="' . $link['icon'] . '" alt="'
                    . $link['title'] . '"></span>' : '';
                    ...
                    if ($allowedit) {
                        if (!$link['url']) {
                            ...
                            $output .= '<li><a class="' . theme_mb2nl_bsfcls(1, '', '', 'center') . '" href="' . $link['url'] . '"'
                            . $cls . $data . '>' . $icon . $link['title'] .
                            $details . '</a></li>';
                        }
                    }
                }
